...
To specify a custom set of app repositories, edit the following JSON file
`app/src/mycompany/assets/default_repos.json`. For example, here's the
Guardian Project repo config enabled by default.
