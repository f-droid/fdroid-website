...
F-Droid is built on free software and only produces free software.  We generally prefer the GNU licenses, but will consider other licenses in specific cases. This is a rough overview of the licenses used throughout the project.
