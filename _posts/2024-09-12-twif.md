...
**[mpvKt: MPV based media player](https://f-droid.org/packages/live.mehiz.mpvkt)**, _A media player based on the popular commandline media player mpv_, was just added, an app that tries to show you the power of `mpv` in a nice UI that's easy to use. Will it replace [your old player](https://f-droid.org/2024/08/22/twif.html)? Do test and [tell us](https://f-droid.org/about/#contact)!
