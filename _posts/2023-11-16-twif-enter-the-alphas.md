...
_Small note from [@Licaon_Kter](https://gitlab.com/licaon-kter): RustDesk currently is flagged with the [Tracking](https://gitlab.com/fdroid/fdroiddata/-/blob/24dd4c6385701057ab11f359ea498da76ed73282/metadata/com.carriez.flutter_hbb.yml#L3-L4) [antifeature](https://f-droid.org/docs/Anti-Features/#Tracking), but Vasyl promised they're on track to fix that so F-Droid users get the chance to use their remote devices in a privacy-friendly way!_
