...
* **[SaidIt](https://f-droid.org/app/org.saiditnet.redreader)**: An official client for news site saidit.net. This app is a fork of QuantumBadger's [RedReader](https://f-droid.org/app/org.quantumbadger.redreader).
...
* **ICSdroid** is also now known as **[ICSx⁵](https://f-droid.org/app/at.bitfire.icsdroid)** following on the steps of DAVx⁵. You can read more about this [here](https://www.davx5.com/faq/general/what-does-davx5-stand-for).
...
* **[Mastalab](https://f-droid.org/app/fr.gouv.etalab.mastodon)** keeps its update pace, already at 1.63.1 bringing
  ...
  * Video automatically in fullscreen in landscape orientation.
