...
According to their [official timeline](https://developer.android.com/developer-verification#timeline), Google intends to open their developer registration console in March. This is the first phase of lock-down, where developers are to be offered the dubious privilege of _paying Google_ so they can surrender their government identification, register all their applications, and become forever locked into Google's terms and conditions for app distribution.
