...
As hinted in [TWIF24-9](https://f-droid.org/2024/02/29/twif.html#community-news), **[sing-box](https://f-droid.org/packages/io.nekohasekai.sfa)**'s inclusion signaled that **SagerNet** and its plugins _(Brook, Hysteria, Mieru, NaïveProxy, Ping Tunnel, TUIC and Trojan-Go)_ need to be archived.
